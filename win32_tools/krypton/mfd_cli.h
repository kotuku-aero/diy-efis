#ifndef __mfd_cli_h__
#define __mfd_cli_h__
...
extern cli_node_t mfd_cli_root;
...
extern result_t recv_can_id_type_val1_val2_val3_val4_action(cli_t *context, uint16_t recv_can_id_, uint16_t recv_can_id_type_, const char * recv_can_id_type_val1_, const char * recv_can_id_type_val1_val2_, const char * recv_can_id_type_val1_val2_val3_, const char * recv_can_id_type_val1_val2_val3_val4_);

extern result_t shell_cp_src_dst_action(cli_t *context, const char * shell_cp_src_, const char * shell_cp_src_dst_);

extern result_t shell_rm_name_action(cli_t *context, const char * shell_rm_name_);

extern result_t shell_mkdir_path_action(cli_t *context, const char * shell_mkdir_path_);

extern result_t shell_rmdir_path_action(cli_t *context, const char * shell_rmdir_path_);

extern result_t shell_cd_path_action(cli_t *context, const char * shell_cd_path_);

extern result_t shell_ls_path_action(cli_t *context, const char * shell_ls_path_);

extern result_t shell_exit_action(cli_t *context);
