...
using CanFly.Tools.Utilities;
using System.Xml;
using CanFly.Tools.MetadataProcessor.Core;
using Mono.Cecil;

namespace CanFly.Tools.MetadataProcessor.MsBuildTask
{
  ...
  public class MetaDataProcessorTask : Task
  {
    ...
    /// <summary>
    /// Array of CanFly assemblies to be passed to MetaDataProcessor in -loadHints switch 
    /// </summary>
    ...
    public override bool Execute()
    {
      ...
      Log.LogCommandLine(MessageImportance.Normal, "Starting CanFly MetadataProcessor...");
