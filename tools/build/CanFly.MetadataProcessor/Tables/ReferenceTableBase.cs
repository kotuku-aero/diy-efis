...
namespace CanFly.Tools.MetadataProcessor
{
  ...
  public abstract class ReferenceTableBase<T> : IAssemblyTable
  {
    /// <summary>
    ...
    /// </summary>
    protected readonly TablesContext _context;
    ...
    /// <summary>
    /// Creates new instance of <see cref="ReferenceTableBase{T}"/> object.
    /// </summary>
