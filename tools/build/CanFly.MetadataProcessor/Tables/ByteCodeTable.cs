...
namespace CanFly.Tools.MetadataProcessor
{
  ...
  /// </summary>
  public sealed class ByteCodeTable : IAssemblyTable
  {
    /// <summary>
    ...
    /// </summary>
    private readonly StringTable _fakeStringTable;
    ...
    /// <summary>
    /// Creates new instance of <see cref="ByteCodeTable"/> object.
    /// </summary>
    /// <param name="context">
    /// Assembly tables context - contains all tables used for building target assembly.
    /// </param>
        ...
        TablesContext context)
    {
      ...
      _fakeStringTable = new StringTable(_context);
    }
    ...
    /// Temporary string table for code generators used during initial load.
    /// </summary>
    public StringTable FakeStringTable { get { return _fakeStringTable; } }
    ...
    private byte[] CreateByteCode(MethodDefinition method)
    {
      if (!method.HasBody)
      {
        return new byte[0];
      ...
      using (var stream = new MemoryStream())
      {
        ...
        {
          CodeWriter codeWriter = new CodeWriter(method, CLRBinaryWriter.CreateBigEndianBinaryWriter(writer), _fakeStringTable, _context);
        ...
        CLRBinaryWriter writer)
    {
      ...
      using (var stream = new MemoryStream())
      {
        CodeWriter codeWriter = new CodeWriter(method, writer.GetMemoryBasedClone(stream), _context.StringTable, _context);
        codeWriter.WriteMethodBody();
        return stream.ToArray();
      }
    }
