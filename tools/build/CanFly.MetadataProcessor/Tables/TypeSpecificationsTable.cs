...
namespace CanFly.Tools.MetadataProcessor
{
  ...
  /// </summary>
  public sealed class TypeSpecificationsTable : IAssemblyTable
  {
    /// <summary>
    ...
    /// <summary>
    /// Creates new instance of <see cref="TypeSpecificationsTable"/> object.
    /// </summary>
    /// <param name="context">
    /// Assembly tables context - contains all tables used for building target assembly.
    /// </param>
    public TypeSpecificationsTable(
    ...
    {
      foreach (TypeReference item in _idByTypeSpecifications
