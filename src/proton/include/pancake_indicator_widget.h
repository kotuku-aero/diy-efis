...
typedef struct _pancake_widget_t {
  ...
  bool bar_fill;            // fill the bars rather than just show the current value
 ...
 * @return 
*/
extern result_t create_pancake_widget(handle_t parent, uint32_t flags, pancake_widget_t*wnd, handle_t *hndl);
