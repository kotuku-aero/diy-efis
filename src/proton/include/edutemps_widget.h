...
typedef struct _edutemps_widget_t {
  widget_t base;
...
extern result_t create_edutemps_widget(handle_t parent, uint32_t flags, edutemps_widget_t* wnd, handle_t* hndl);
