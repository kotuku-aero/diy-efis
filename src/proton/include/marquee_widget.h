...
typedef struct _alarm_t {
  ...
  annunciator_t* annunciator; // the annunciator that should be displayed when the alarm is raised
 ...
 * @return 
*/
extern result_t create_marquee_widget(handle_t parent, uint32_t flags, marquee_widget_t* wnd, handle_t* hndl);
/**
 ...
 * @return 
*/
extern result_t create_alarm_annunciator(handle_t parent, uint32_t flags, alarm_t* wnd, handle_t* out);
