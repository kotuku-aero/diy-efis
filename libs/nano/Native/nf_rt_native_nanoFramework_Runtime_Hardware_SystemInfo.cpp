...
GetSystemVersion___STATIC__VOID__BYREF_I4__BYREF_I4__BYREF_I4__BYREF_I4(CLR_RT_StackFrame& stack)
  {
...
HRESULT Library_nf_rt_native_nanoFramework_Runtime_Native_SystemInfo::get_OEMString___STATIC__STRING(
...
HRESULT Library_nf_rt_native_nanoFramework_Runtime_Native_SystemInfo::get_TargetName___STATIC__STRING(
  CLR_RT_StackFrame& stack)
  {
  NATIVE_PROFILE_CLR_CORE();
...
HRESULT Library_nf_rt_native_nanoFramework_Runtime_Native_SystemInfo::get_Platform___STATIC__STRING(
  CLR_RT_StackFrame& stack)
  {
  NATIVE_PROFILE_CLR_CORE();
...
HRESULT Library_nf_rt_native_nanoFramework_Runtime_Native_SystemInfo::GetNativeFloatingPointSupport___STATIC__U1(
  CLR_RT_StackFrame& stack)
  {
  NANOCLR_HEADER();
  {
