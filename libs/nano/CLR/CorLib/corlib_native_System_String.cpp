...
#define c_IndexOf__SingleChar 0x0001
#define c_IndexOf__StartIndex 0x0002
#define c_IndexOf__Count 0x0004
#define c_IndexOf__Last 0x0008
#define c_IndexOf__MultipleChars 0x0010
#define c_IndexOf__String 0x0020
#define c_IndexOf__String_Last 0x0040
...
HRESULT Library_corlib_native_CanFly_Runtime::StringConcat___STATIC__STRING__SZARRAY_STRING(CLR_RT_StackFrame& stack)
  ...
  NANOCLR_SET_AND_LEAVE(StringConcat(stack, (CLR_RT_HeapBlock*)pArray->GetFirstElement(), pArray->m_numOfElements));
