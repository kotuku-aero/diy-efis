...
HRESULT CLR_RT_BinaryFormatter::ReadBits(CLR_UINT32 &res, int bits) { (void)res; (void)bits; NANOCLR_FEATURE_STUB_RETURN(); }
HRESULT CLR_RT_BinaryFormatter::WriteBits(CLR_UINT32  val, int bits) { (void)val; (void)bits; NANOCLR_FEATURE_STUB_RETURN(); }

HRESULT CLR_RT_BinaryFormatter::ReadBits(CLR_UINT64 &res, int bits) { (void)res; (void)bits; NANOCLR_FEATURE_STUB_RETURN(); }
HRESULT CLR_RT_BinaryFormatter::WriteBits(CLR_UINT64  val, int bits) { (void)val; (void)bits; NANOCLR_FEATURE_STUB_RETURN(); }

HRESULT CLR_RT_BinaryFormatter::ReadArray(CLR_UINT8 *buf, int bytes) { (void)buf; (void)bytes; NANOCLR_FEATURE_STUB_RETURN(); }
HRESULT CLR_RT_BinaryFormatter::WriteArray(const CLR_UINT8 *buf, int bytes) { (void)buf; (void)bytes; NANOCLR_FEATURE_STUB_RETURN(); }
