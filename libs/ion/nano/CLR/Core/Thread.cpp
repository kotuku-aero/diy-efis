...
void CLR_RT_Thread::BringExecCounterToDate(int iGlobalExecutionCounter)
  ...
  if (m_executionCounter - iGlobalExecutionCounter > (int)((1 << (ThreadPriority_Highest + 1)) + 1))
    {
    m_executionCounter = iGlobalExecutionCounter + (int)((1 << (ThreadPriority_Highest + 1)) + 1);
    }
  }
