...
extern int stbtt_BakeFontBitmap(handle_t data, int offset,  // font location (use offset=0 for plain .ttf)
...
extern int stbtt_GetNumberOfFonts(handle_t data);
...
extern int stbtt_GetFontOffsetForIndex(handle_t data, int index);
...
extern int stbtt_InitFont(stbtt_fontinfo *info, handle_t data, int offset);
...
extern int stbtt_BakeFontBitmap_fontinfo(stbtt_fontinfo *f, int offset,  // font location (use offset=0 for plain .ttf)
  float pixel_height,                     // height of font in pixels
  unsigned char *pixels, int pw, int ph,  // bitmap to be filled in
  int first_char, int num_chars,          // characters to bake
