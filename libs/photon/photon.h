...
#define id_photon 1750
#define id_first_internal_msg id_photon
// specific window messages
#define id_paint (id_photon +1)
#define id_create (id_photon +2)
#define id_close (id_photon +3)
#define id_timer (id_photon +4)
#define id_key0 (id_photon +5)
#define id_key1 (id_photon +6)
#define id_key2 (id_photon +7)
#define id_key3 (id_photon +8)
#define id_key4 (id_photon +9)
#define id_decka (id_photon +10)
#define id_deckb (id_photon +11)
#define id_menu_up (id_photon +12)
#define id_menu_dn (id_photon +13)
#define id_menu_left (id_photon +14)
#define id_menu_right (id_photon +15)
#define id_menu_ok (id_photon +16)
#define id_menu_cancel (id_photon +17)
#define id_menu_select (id_photon +18)
#define id_buttonpress (id_photon +19)
#define id_last_internal_msg id_buttonpress
