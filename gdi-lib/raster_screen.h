...
public:
  ...
  virtual void polyline(canvas_t *canvas, const rect_t &clip_rect, const pen_t *, const point_t *points, size_t count);
  virtual void fill_rect(canvas_t *canvas, const rect_t &clip_rect, const rect_t &, color_t);
  virtual void ellipse(canvas_t *canvas, const rect_t &clip_rect, const pen_t *, color_t, const rect_t &);
  virtual void polygon(canvas_t *canvas, const rect_t &clip_rect, const pen_t *, color_t, const point_t *, size_t count, bool interior_fill);
  virtual void rectangle(canvas_t *canvas, const rect_t &clip_rect, const pen_t *, color_t, const rect_t &);
  virtual void round_rect(canvas_t *canvas, const rect_t &clip_rect, const pen_t *, color_t, const rect_t &, const extent_t &);
  virtual void pattern_blt(canvas_t *canvas, const rect_t &clip_rect, const bitmap_t *, const rect_t &, raster_operation mode);
  virtual void bit_blt(canvas_t *canvas, const rect_t &clip_rect, const rect_t &dest_rect, const screen_t *src_screen, const rect_t &src_clip_rect,
  ...
  virtual void scroll(canvas_t *canvas, const rect_t &clip_rect, const extent_t &offsets,
                      ...
                      rect_t *rect_update);
  virtual void background_mode(canvas_t *canvas, int m);
  virtual void invalidate_rect(canvas_t *canvas, const rect_t &);
