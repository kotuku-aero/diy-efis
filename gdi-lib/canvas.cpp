...
kotuku::canvas_t::canvas_t(window_t *owner,
                   canvas_t &parent,
                   const rect_t &rect)
  {
  _screen = the_hal()->screen_create(parent._screen, rect);
  ...
  _background_mode = opaque;
  _invalid = false;
  }

kotuku::canvas_t::canvas_t(canvas_t &c, const extent_t &e)
  {
  _screen = the_hal()->screen_create(c._screen, e);
...
kotuku::canvas_t::canvas_t(canvas_t &c, const bitmap_t &b)
  {
  _screen = c._screen->create_canvas(c._screen, b);
...
kotuku::canvas_t::canvas_t(canvas_t &c, const rect_t &r)
: _screen(c._screen),
  _window_rect(r),
  _clipping_rect(r)
  {
...
kotuku::canvas_t::canvas_t(screen_t *screen, const rect_t &r)
: _screen(screen),
  _window_rect(r),
  _clipping_rect(r)
  {
...
kotuku::canvas_t::e_background_mode kotuku::canvas_t::background_mode() const
  {
...
void kotuku::canvas_t::mask_blt(const rect_t &dest_rect,
                               const canvas_t &src_canvas,
                               const point_t &src_pt,
