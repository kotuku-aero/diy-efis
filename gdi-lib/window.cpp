...
kotuku::window_t::window_t(window_t &parent,
             ...
             uint32_t id)
: _parent(&parent),
  canvas_t(parent.screen(), window_rect),
  _id(id),
  _previous(0),
  _next(0),
  _child(0),
...
kotuku::rect_t kotuku::window_t::get_window_rect(const char *section_name)
  ...
  rect_t result;
  int value;
  the_app()->get_config_value(section_name, "origin-x", value);
  result.left = value;
  the_app()->get_config_value(section_name, "origin-y", value);
  result.top = value;
  the_app()->get_config_value(section_name, "extent-x", value);
  result.right = result.left + value;
  the_app()->get_config_value(section_name, "extent-y", value);
