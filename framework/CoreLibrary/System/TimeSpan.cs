...
namespace System
{
  ...
  public struct TimeSpan
  {
    ...
    /// indicates whether this instance is shorter than, equal to, or longer 
    ...
    {
      return new TimeSpan(TimeSpan.TicksPerMillisecond * value);
    }
    ...
    {
      return new TimeSpan(TimeSpan.TicksPerSecond * value);
    }
    ...
    {
      return new TimeSpan(TimeSpan.TicksPerMinute * value);
    }
    ...
    {
      return new TimeSpan(TimeSpan.TicksPerHour * value);
    }
    ...
    {
      return new TimeSpan(TimeSpan.TicksPerDay * value);
    }
