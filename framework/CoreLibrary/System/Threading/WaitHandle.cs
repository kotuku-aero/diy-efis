...
namespace System.Threading
{
  ...
  public abstract class WaitHandle : MarshalByRefObject
  {
    ...
    public virtual bool WaitOne(int millisecondsTimeout, bool exitContext) { return CanFly.Runtime.WaitHandleWaitOne(this, millisecondsTimeout, exitContext); }
    ...
    {
      return CanFly.Runtime.WaitMultiple(waitHandles, millisecondsTimeout, exitContext, waitAll);
    }
