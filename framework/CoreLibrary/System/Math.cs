...
namespace System
{
    ...
    public class Math
    {
        ...
        public static int Abs(int val) { return CanFly.Runtime.Abs(val); }
        /// <summary>
        ...
        public static int Max(int val1, int val2) { return CanFly.Runtime.Max(val1, val2); }
        /// <summary>
        ...
        public static int Min(int val1, int val2) { return CanFly.Runtime.Min(val1, val2); }
        /// <summary>
        ...
        public static double Abs(double val) { return CanFly.Runtime.Abs(val); }
        /// <summary>
        ...
        /// </remarks>
        public static double Acos(double d) { return CanFly.Runtime.Acos(d); }
        /// <summary>
        ...
        public static double Asin(double d) { return CanFly.Runtime.Asin(d); }
        /// <summary>
        ...
        public static double Atan(double d) { return CanFly.Runtime.Atan(d); }
        /// <summary>
        ...
        public static double Atan2(double y, double x) { return CanFly.Runtime.Atan2(x, y); }
        /// <summary>
        ...
        public static double Ceiling(double d) { return CanFly.Runtime.Ceiling(d); }
        /// <summary>
        ...
        public static double Cos(double a)  { return CanFly.Runtime.Cos(a); }
        /// <summary>
        ...
        public static double Cosh(double a) { return CanFly.Runtime.Cosh(a);}
        /// <summary>
        ...
        public static double IEEERemainder(double x, double y) { return CanFly.Runtime.IEEERemainder(x, y); }
        /// <summary>
        ...
        public static double Exp(double d) { return CanFly.Runtime.Exp(d); }
        /// <summary>
        ...
        public static double Floor(double d) { return CanFly.Runtime.Floor(d); }
        /// <summary>
        /// Returns the natural (base e) logarithm of a specified number.
        /// </summary>
        /// <param name="d">The number whose logarithm is to be found. </param>
        /// <returns>The natural logarithm of d; that is, ln d, or log e d</returns>
        public static double Log(double d) { return CanFly.Runtime.Log(d); }
        /// <summary>
        /// Returns the base 10 logarithm of a specified number.
        /// </summary>
        /// <param name="d">A number whose logarithm is to be found. </param>
        /// <returns>The base 10 log of d; that is, log 10 d.</returns>
        public static double Log10(double d) { return CanFly.Runtime.Log10(d); }
        /// <summary>
        ...
        public static double Max(double x, double y) { return CanFly.Runtime.Max(x, y); }
        /// <summary>
        ...
        public static double Min(double x, double y) { return CanFly.Runtime.Min(x, y); }
        ...
        public static double Pow(double x, double y) { return CanFly.Runtime.Pow(x, y); }
        /// <summary>
        ...
        public static double Sinh(double value) { return CanFly.Runtime.Sinh(value); }
        /// <summary>
        /// Returns the square root of a specified number.
        /// </summary>
        /// <param name="d">The number whose square root is to be found. </param>
        /// <returns>The positive square root of d.</returns>
        public static double Sqrt(double d) { return CanFly.Runtime.Sqrt(d); }
        /// <summary>
        ...
        public static double Tan(double a) { return CanFly.Runtime.Tan(a); }
        /// <summary>
        ...
        public static double Tanh(double value) { return CanFly.Runtime.Tanh(value); }
        /// <summary>
        ...
        public static double Truncate(double d) { return CanFly.Runtime.Truncate(d); }
    }
}
