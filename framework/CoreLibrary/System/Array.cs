...
namespace System
{
  ...
  public abstract class Array : IList
  {
    ...
    {
      CanFly.Runtime.Copy(sourceArray, 0, destinationArray, 0, length);
    }
    ...
    {
      CanFly.Runtime.Clear(array, index, length);
    }
    ...
    public int Length
    {
      get {  return CanFly.Runtime.GetArrayLength(this); }
    }
    ...
    {
      get { return CanFly.Runtime.GetArrayAt(this, index); }
      set { CanFly.Runtime.SetArrayAt(this, index, value); }
    }
    ...
    public static int IndexOf(Array array, Object value, int startIndex, int count)
    {
      ...
      if (CanFly.Runtime.TrySzIndexOf(array, startIndex, count, value, out retVal))
      {
        return retVal;
      }
