...
{
  public class AirspeedWidget : Widget
  {
    private ushort _vs0;
    private ushort _vs1;
    private ushort _vfe;
      ...
      : base(parent, bounds, id)
    {
      ...
      TryRegGetFloat(key, "offset", out _offset);
      ...
      CanFlyMsgSink.AddEventListener(CanFlyID.id_indicated_airspeed, OnIndicatedAirspeed);
