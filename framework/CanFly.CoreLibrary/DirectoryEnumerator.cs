  ...
  public class DirectoryEnumerator : IEnumerator
  {
    ...
    public object Current
    {
      get
      {
        string path = null;
        string name = null;
        bool isFile = GetDirectoryEntry(_handle, ref path, ref name);
        _enumPos++;
    ...
    private static extern bool GetDirectoryEntry(uint hndl, ref string path, ref string name);
    [MethodImpl(MethodImplOptions.InternalCall)]
    private static extern void RewindDirectoryEntry(uint hndl);
  }
}
